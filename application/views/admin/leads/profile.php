...
<div class="<?php if ($openEdit == true) {
    ...
    <div class="row">
        <div class="lead-view<?php if (!isset($lead)) {
            ...
            <?php
            // $leadwithreport =   get_lead_with_empty_report_status();
            // $report = generate_lighthouse_report($leadwithreport->)                                    
            // if ($lead) {
            //     echo '<pre>';
            //     print_r($leadwithreport); // Print the entire lead object
            //     echo '</pre>';
            // } else {
            //     echo 'No lead found with an empty report status.';
            // }
            ?>
            ...
            <div class="col-md-4 col-xs-12 lead-information-col">
                ...
                <dl>
                    <dt class="lead-field-heading tw-font-medium tw-text-neutral-500 no-mtop"> Report : </dt>
                    <dd class="tw-text-neutral-900 tw-mt-1 tw-break-words"> <?php echo get_lead_report_status($lead->id) ?></dd>
                </dl>
                <dl>
                    <dt class="lead-field-heading tw-font-medium tw-text-neutral-500 no-mtop"> Report URL : </dt>
                    <dd class="tw-text-neutral-900 tw-mt-1 tw-break-words"> <a href="<?php echo get_lead_report_url($lead->id) ?>" target="_blank" rel="noopener noreferrer">Preview Report</a> </dd>
                </dl>
