...
*
*/
define('APP_BASE_URL', 'http://seowithperfex.local/');
...
*/
define('APP_ENC_KEY', 'cec6163e5f0edf5aeeb0a287870c0f9c');
 ...
 */
define('APP_DB_PASSWORD', '123');

/**
 * The name of the database you want to connect to
 */
define('APP_DB_NAME', 'seo_perfex');
